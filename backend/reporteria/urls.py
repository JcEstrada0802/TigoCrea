...
from .views import getSystems, crearReporte, getReports, logout, getReportDetail, exportReportPDF, getUserContext, updateReport
...
urlpatterns = [ path('api-token-auth/', obtain_auth_token, name='api_token_auth'), 
                ...
                path('getReport/<int:report_id>/', getReportDetail, name='getReportDetail'), 
